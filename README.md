...
If you are reading the .json file, make sure to point the directory where the data resides by changing this line found in code 1.1: C:/Users/adith/Documents/data-512-final-project/Data/GeoJson_Exports/USGS_Wildland_Fire_Combined_Dataset.json
...
- [1.2_SmokeEstimateCalculation.ipynb](https://github.com/adithyaav27/data-512-final-project/blob/main/1.2_SmokeEstimateCalculation.ipynb) : Ideates and creates the Smoke Estimate for 1963-2020.
...
- [1.5_Report_Visualizations.ipynb](https://github.com/adithyaav27/data-512-final-project/blob/main/1.5_Report_Visualizations.ipynb) : Answers the Questions asked in Step 2 of common analysis Assignment on Canvas.
- [2_ImpactAnalysis](https://github.com/adithyaav27/data-512-final-project/blob/main/2_ImpactAnalysis.ipynb): Reads health realted variables, compares it with Smoke Estimate to understand the impact of smoke on the health of the people. It uses [Ordinary Least Sqaure regression](https://www.statsmodels.org/stable/regression.html) technique as a part of the analysis.
  
A dependant library class is available in [/wildfire](https://github.com/adithyaav27/data-512-final-project/tree/main/wildfire). This is imported within the notebooks.
...
- [Total Acres Burned.png](https://github.com/adithyaav27/data-512-final-project/blob/main/Images/Q2.png) : This is a graphical representation that illustrates the spatial distribution of wildfires in relation to Farmington, NM, spanning the years 1963 to 2020.
...
- From the above, it is clear that Smoke exposure will have some impact on the health of the people of Farmington, NM. Hence, there is a critical need for immediate public health measures to address the issue of smoke exposure. It also emphasizes the importance of integrating data on the impact of smoke into health and community planning efforts. This analysis also underscores the necessity of developing long-term strategies aimed at minimizing smoke exposure, especially among at-risk groups. Lastly, it suggests that future policies should be shaped by continuous examination and understanding of the correlation between smoke exposure levels and health effects.
